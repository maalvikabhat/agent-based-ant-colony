...
- assessment goes to canvassing (tandem run) 
- in tandem run, we account for population with quorum met!! (explain this formula and what quorum met is and how the formula works) 
- - simplifying timesteps for the sake of the model
- talk about commitment phase and tandem runs and following committed ant
