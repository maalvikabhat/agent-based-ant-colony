...
### Motivation 
Group living expands the behavioural complexity of animals, by making possible collective acts that arise from interactions among group members. These orderly global patterns emerge without central control by well-informed leaders, and each animal instead applies appropriate decision rules to purely local information! Understanding this emergence can sometimes be hindered by the number and variety of group members. Despite their natural applicability to insect societies, agent-based models have seldom been usefully applied till the last few decades. Their main weakness has been the lack of adequate data to reliably estimate model parameters. The goal of our project was to understand the emigration process for ants and to understand, visually, how they choose their nests.
