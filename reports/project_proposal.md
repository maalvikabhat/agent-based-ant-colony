...
### Areas of Concern
Our largest area of concern is the scope of the project. With the abundance of parameters presented in the original paper, we are concerned we will accidentally model something incorrectly which would cause our results to vary greatly. Nevertheless, we hope to preserve the integrity of the model and accurately capture each parameter and translate the information presented in the graph into a precise finite state machine.
